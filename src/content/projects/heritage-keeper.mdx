...
**Hello folks!** Welcome to another project overview. This time we are going to review **Heritage Keeper**, a web application developed in *48 hours* and the winner of **Codicon 2024** *(the yearly hackaton sponsored by [Lexpin](https://lexpin.online/) academy)*. 
...
I want to give special thanks to my amazing teammates [Juan Álvarez](https://github.com/juanzenn) and [Pedro Uzcátegui](https://github.com/pedrouzcategui) with whom I had the pleasure to work and create great software.

<div class="w-full h-1 bg-primary"></div>

**That's all for today folks!** I hope you enjoyed this project overview. If you have any questions or comments, feel free to contact me in my social media. I'll be happy to answer them. See you in the next project overview! 👋🏼.
